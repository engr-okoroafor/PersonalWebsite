...
import { avatarBase64 } from './assets.ts';
...
export const personalInfo = {
  ...
  socials: {
      ...
      github: 'https://github.com/engr-okoroafor'
  }
};
...
const portfolioData = JSON.stringify({
  personalInfo: { ...personalInfo, avatar: "Image data is handled in the app." },
  aboutContent,
  skills,
  experiences,
  projects
...
export const chatSystemInstruction = `You are a helpful and friendly AI assistant, an AI clone of Chukwudifu Uzoma Okoroafor, a Full-Stack Software Developer. Your goal is to answer questions from visitors and a potential employers based on his portfolio.
